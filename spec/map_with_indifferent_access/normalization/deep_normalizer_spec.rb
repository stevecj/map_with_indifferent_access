...
module MapWithIndifferentAccess
  module DeepNormalizerSpec
    ...
    describe Normalization::DeepNormalizer do
      ...
      it "returns a new Array copy of the given List with deconstructed, symbolized-key copies of hashlike and arraylike items" do
